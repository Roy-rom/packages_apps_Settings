...
public class TopMenu extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        LinearLayout mDevice = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/device", null, context.getPackageName()));
        mDevice.setClickable(true);
        mDevice.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setComponent(new ComponentName("com.android.settings", "com.android.settings.Settings$AdvancedConnectedDeviceActivity"));
                context.startActivity(intent);
            }
        });
        
        LinearLayout mNotification = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/notification", null, context.getPackageName()));
        mNotification.setClickable(true);
       ...
       LinearLayout mSystem = holder.itemView.findViewById(context.getResources().
        ...
        LinearLayout mWallpaper = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/wallpaper", null, context.getPackageName()));
        mWallpaper.setClickable(true);
        mWallpaper.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setComponent(new ComponentName("com.android.settings", "com.android.settings.Settings$WallpaperSettingsActivity"));
                context.startActivity(intent);
            }
        });

        LinearLayout mPrivacy = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/privacy", null, context.getPackageName()));
        mPrivacy.setClickable(true);
        mPrivacy.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setComponent(new ComponentName("com.android.settings", "com.android.settings.Settings$PrivacyDashboardActivity"));
                context.startActivity(intent);
            }
        });
        
        
        LinearLayout mApps = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/apps", null, context.getPackageName()));
        mApps.setClickable(true);
        ...
        LinearLayout mAccessibility = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/accessibility", null, context.getPackageName()));
        mAccessibility.setClickable(true);
        mAccessibility.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
        ...
        LinearLayout mSound = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/sound", null, context.getPackageName()));
        ...
        LinearLayout mStorage = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/storage", null, context.getPackageName()));
